...
const REDIRECT_URI = "https://vfkjiprgawimhmieikyw.supabase.co/functions/v1/canva-oauth-callback";
...
Deno.serve(async (req) => {
  ...
  return html("<h1>Canva connected</h1><p>You can close this tab now.</p>");
});
